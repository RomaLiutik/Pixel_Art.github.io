...
bttn_clear = Button(text = 'Clear', height = 2, width = 7, command = lambda : clear())
bttn_clear.place(x = 405, y = 275)
...
def create_lines():
    a = 0
    while a != 15:
        cns.create_line(20*a,0,20*a,320)
        a = a + 1
    a = 0
    while a != 15:
        cns.create_line(0,20*a, 320, 20*a)
        a = a +1
